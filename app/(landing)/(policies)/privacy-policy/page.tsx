        ...
        <div className="container">
          <div className="page-title__inner" style={{ padding: '60px 0 40px' }}>
            <div className="page-title__title-box">
              <h3 className="page-title__title" style={{ color: '#FFFFFF', fontSize: '32px', marginBottom: '20px' }}>Privacy Policy</h3>
            </div>
            ...
            <div className="career-page-top__single">
              <div className="career-page-top__content-box" style={{ backgroundColor: '#000000', border: '1px solid #333333', maxHeight: '70vh', overflowY: 'auto', padding: '30px' }}>
                <div className="career-page-top__content-box-two">
                  ...
                  <ul className="career-page-top__points-list list-unstyled">
                    <li>
                      <div className="career-page-top__points-shape"></div>
                        ...
                        on ufcaibot.com, we may collect the following personal
                        information: Name, Email address, Payment information
                        (for purchasing Token packs).
                      </p>
                    </li>
                    <li>
                      <div className="career-page-top__points-shape"></div>
                  ...
                  <ul className="career-page-top__points-list list-unstyled">
                    ...
                    <li>
                      <div className="career-page-top__points-shape"></div>
                        ...
                        Token packs and to manage your account.
                      </p>
                    </li>
                    <li>
                      <div className="career-page-top__points-shape"></div>
                  ...
                  <h4 className="career-page-top__title-3" style={{ color: '#FFFFFF' }}>Data Security</h4>
                  ...
                  <h4 className="career-page-top__title-3" style={{ color: '#FFFFFF' }}>Your Rights</h4>
                  <ul className="career-page-top__points-list list-unstyled">
                    <li>
                      <div className="career-page-top__points-shape"></div>
                                              <p style={{ color: '#FFFFFF' }}>
