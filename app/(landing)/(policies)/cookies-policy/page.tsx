        ...
        <div className="container">
          <div className="page-title__inner" style={{ padding: '60px 0 40px' }}>
            <div className="page-title__title-box">
              <h3 className="page-title__title" style={{ color: '#FFFFFF', fontSize: '32px', marginBottom: '20px' }}>Cookies Policy</h3>
            </div>
              ...
              <div className="career-page-top__content-box" style={{ backgroundColor: '#000000', border: '1px solid #333333', maxHeight: '70vh', overflowY: 'auto', padding: '30px' }}>
                <div className="career-page-top__content-box-two">
                  ...
                  <p className="career-page-top__text-1 pt-8" style={{ color: '#FFFFFF' }}>
                    At ufcaibot.com, we use cookies to enhance your browsing
                    experience, provide personalized fight prediction services, and analyze our
                  ...
                  <p className="career-page-top__text-1" style={{ color: '#FFFFFF' }}>
                    We use the following types of cookies on ufcaibot.com:
                  </p>
                  ...
                  <p className="career-page-top__text-1" style={{ color: '#FFFFFF' }}>We use cookies to:</p>
                  <ul className="career-page-top__points-list list-unstyled pt-4">
                    <li>
                      <div className="career-page-top__points-shape"></div>
                        <p style={{ color: '#FFFFFF' }}>Ensure the website functions properly and securely</p>
                    </li>
                    <li>
                      <div className="career-page-top__points-shape"></div>
                                              <p style={{ color: '#FFFFFF' }}>
                  ...
                  <ul className="career-page-top__points-list list-unstyled pt-4">
                    <li>
                      <div className="career-page-top__points-shape"></div>
                        <p style={{ color: '#FFFFFF' }}>Set your browser to block or delete cookies</p>
                    </li>
                    <li>
                      <div className="career-page-top__points-shape"></div>
                                              <p style={{ color: '#FFFFFF' }}>
