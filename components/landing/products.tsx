    ...
    <section id="products" className="relative">
      ...
      <div className="bg-[#0a0a0a]">
        ...
        <div className="relative w-full min-h-screen">
          ...
          {/* Content Layer - Proper flow layout */}
          <div className="relative z-10 w-full min-h-screen flex flex-col">
            ...
            <div className="container mx-auto px-4 pt-16 lg:pt-24">
              <motion.div
                ...
                className="max-w-7xl mx-auto"
              >
                <div className="lg:w-[55%] xl:w-[50%] space-y-6">
                  <h3 
                    className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight"
                    style={{ 
                      color: '#ffffff',
            ...
            {/* Fighter Info - Grows to fill remaining space */}
            ...
            {/* Navigation Dots - Bottom of section */}
            <div className="pb-8 md:pb-12 flex justify-center gap-3">
